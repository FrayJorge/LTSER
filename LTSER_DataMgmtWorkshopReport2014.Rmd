...
* **DIEMS** (Drupal Ecological Information Management System) was presented in the workshop.  This is a content management system that facilitates the communication among researchers, data sharing, and metadata creation.  The following links will help you get started: 
    + https://www.drupal.org/project/deims
    + https://github.com/lter/deims

Document Source
-------------------------
This document can was written in Rmarkdown, an open source text editing language, and is stored on gitHub.
